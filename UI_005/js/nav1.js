...
//nav_click_handler 는 nav 의 3가지 요소에게 공통으로 연결이 되어있다.
// nav 3가지 요소중 어떤 것을 클릭해도 동일한 alert가 작동된다.
// 어떤 nav 요소가 클릭되었는지 확인하기 위하여
//event 라는 매개 변수를 설정하였다.
// nav 3가지 요소 (li tag)중 어떤 부분이 클릭이 되면
//nav_click_hadler() 함수가 실행되고, 클릭된 요소의 정보가 event 매개변수를 통하여 전달된다.
